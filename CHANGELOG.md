...
- `explainHandoff(result)` maps each handoff decision to a stable reason code
  and concise summary for renderer-neutral traces, dashboards, and support
  telemetry. The simulated integration example now demonstrates the explained
  decision stream.
